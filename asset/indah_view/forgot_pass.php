...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="assets/tlogin/vendor/bootstrap/css/bootstrap.min.css">
<!--===============================================================================================-->
				...
				<form class="login100-form validate-form">
					...
					<!-- <div class="wrap-input100"> -->
						<div class="text-center p-t-5">
							<input type="checkbox" name="forgotpass"/>
							<span class="txt1">
								I agree to the
							</span>
							<a class="txt2" href="#">
					...
					<div class="text-center p-t-125 p-b-10">
