...
-- Dumping data for table content_provider.groups_auth: ~13 rows (approximately)
/*!40000 ALTER TABLE `groups_auth` DISABLE KEYS */;
INSERT INTO `groups_auth` (`id`, `created`, `modified`, `id_group`, `id_menu`, `active`) VALUES
	(1, '2020-02-18 16:21:55', '2020-02-18 16:21:55', 1, 1, 1),
	(2, '2020-02-18 17:00:52', '2020-02-18 17:00:52', 1, 2, 1),
	(3, '2020-02-18 17:00:52', '2020-09-23 11:07:28', 1, 3, 1),
	(4, '2020-02-18 17:00:52', '2020-09-23 11:07:29', 1, 4, 1),
	...
	(12, '2020-02-18 17:08:29', '2020-09-22 16:27:30', 1, 7, 1),
...
-- Dumping data for table content_provider.menu: ~9 rows (approximately)
...
INSERT INTO `menu` (`id`, `created`, `modified`, `id_type`, `content`, `link`, `icon`, `is_parent`, `id_parent`, `level`, `have_function`, `active`, `short`) VALUES
	(1, '2020-02-18 16:59:50', '2020-09-24 11:23:56', 1, 'Add User  O', 'add_user', 'fas fa-fw fa-user-plus', 0, 0, 0, 0, 1, 1),
	(2, '2020-02-18 16:16:22', '2020-09-24 10:03:30', 1, 'Add Video   O', 'upload_video', 'fas fa-fw fa-upload', 0, 0, 0, 0, 1, 2),
	(3, '2020-02-18 16:59:50', '2020-09-24 11:25:03', 1, 'Add Image x', 'add_image', 'fas fa-fw fa-file-image', 0, 0, 0, 0, 1, 3),
	(4, '2020-02-18 16:59:50', '2020-09-24 11:28:20', 1, 'Add Info Grafis  O', 'upload_infografis', 'fas fa-fw fa-info-circle', 0, 0, 0, 0, 1, 4),
	(5, '2020-02-18 16:56:53', '2020-09-24 11:33:53', 1, 'Log Upload    O', 'history_upload', 'fas fa-fw fa-list', 0, 0, 0, 0, 1, 5),
	(6, '2020-02-18 16:59:50', '2020-09-24 09:34:11', 1, 'Log Download   O', 'log_download', 'fas fa-fw fa-history', 0, 0, 0, 0, 1, 6),
	(333, '2020-02-18 16:57:49', '2020-09-23 11:05:59', 1, 'Pricing Video', 'pricing_video', 'fas fa-fw fa-list', 0, 0, 0, 0, 1, 0),
	(444, '2020-02-18 16:58:22', '2020-09-23 11:06:06', 1, 'Pricing History 1', 'history_pricing', 'fas fa-fw fa-history', 0, 0, 0, 0, 1, 0),
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `token_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `image`, `nik`, `id_group`) VALUES
	...
	(9, '127.0.0.1', 'kemal.wibisono@cnn.id', '739c6beead44c6c4b99838fb98d00813793b80071a4e1182f660956c5b7d03d5f85d0f3f07845d7e2cc610a8fcf9f328f192b91aaf17f161de10618d48e6de8avoFcmpaktkh1vZMSUnZvdikUEwEhgIWaP+IAU7pRm+8=', NULL, 'kemal.wibisono@cnn.id', NULL, '72075400', NULL, NULL, '2018-08-29', '2020-09-24 07:32:38', 'K560RWl1s6JHxF1aeEOvNd24tJwwC2KJVNEpydcE2Ubx4NGEokCbpJCKBZAwLEPc9Ffat3YoX4dEm2uIN2ctXxLhBkcVAuBtjd2Z', 1, 'Kemal', 'Wibisono', NULL, '082308236757', 'img.png', 1, 1),
...
-- Dumping data for table content_provider.video_category: ~5 rows (approximately)
...
INSERT INTO `video_category` (`id`, `created`, `created_by`, `modified`, `modified_by`, `content`, `active`) VALUES
	(1, '2020-03-09 10:47:21', 0, '2020-03-09 10:47:21', 0, 'NATIONAL', 1),
	(2, '2020-03-09 10:47:21', 0, '2020-03-09 10:47:21', 0, 'INTERNATIONAL', 1),
	(3, '2020-03-09 10:47:21', 0, '2020-03-09 10:47:21', 0, 'ECONOMY', 1),
	(4, '2020-03-09 10:47:21', 0, '2020-03-09 10:47:21', 0, 'SPORT', 1),
	(5, '2020-03-09 10:47:21', 0, '2020-03-09 10:47:21', 0, 'TECHNOLOGY', 1);
...
INSERT INTO `video_meta` (`id_video`, `uploader`, `video_title`, `description`, `journalist`, `video_id`, `video_low`, `id_thumbnail`, `uploaded_date`, `tag`, `id_status`, `id_video_type`, `id_video_category`, `duration`, `id_video_price`, `user_do_pricing`, `user_approve`, `active`) VALUES
	...
	(30, 16, 'For A Grande', 'For A Grande', 'Almer', '578dde315996601845dff7af46da393f_WhatCarCanYouGetForAGrand.mp4', '578dde315996601845dff7af46da393f_WhatCarCanYouGetForAGrand.m3u8', '578dde315996601845dff7af46da393f_Capture.PNG', '2020-06-23 07:59:39', 'Tokoh', 3, 1, 2, '01:01:01', 1, 16, 16, 1),
	(31, 16, 'Blazae', 'Blaze', 'Blaze', '71b0ee59152c72c316317321168efa17_ForBiggerBlazes.mp4', '71b0ee59152c72c316317321168efa17_ForBiggerBlazes.m3u8', '71b0ee59152c72c316317321168efa17_Capture.PNG', '2020-06-23 09:52:44', 'Politkk', 1, 0, 2, '01:01:01', 0, 0, 0, 1),
	...
	(33, 13, 'Kantor', 'Testing', 'Soki', '0bccb137501a072329d23839681d124c_20200625_183902.mp4', '0bccb137501a072329d23839681d124c_20200625_183902.m3u8', '0bccb137501a072329d23839681d124c_20200618_145916.jpg', '2020-06-25 11:40:31', 'Testing', 2, 1, 1, '00:01:00', 2, 14, 0, 1),
	(34, 9, 'Video Test', 'Video Test', 'Almer', 'a17d0b8e406bf7e4a40acd09ecadcc66_ElephantsDream.mp4', 'a17d0b8e406bf7e4a40acd09ecadcc66_ElephantsDream.m3u8', 'a17d0b8e406bf7e4a40acd09ecadcc66_Capture.PNG', '2020-09-11 08:51:02', 'Politik', 1, 0, 1, '00:00:00', 0, 0, 0, 1),
