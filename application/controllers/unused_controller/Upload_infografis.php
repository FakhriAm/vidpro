...
class Upload_infografis extends MY_Controller {
	...
	public function index(){
        ...
        $this->load->view('part/default/wrapper',array('content'=>'upload_infografis/upload_infografis_view','content_js'=>'upload_infografis/upload_infografis_js','menu'=>$this->getAllUserMenu(),'filter_category'=>form_dropdown('',$opt,'','name="id_video_category" class="form-control"')));
	}
