...
<script>
	...
	function statLatestVideoMandatory() {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-video-mandatory') ?>";
	...
	function statLatestVideoMandatoryByCategory() {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-video-mandatory-by-category') ?>";
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
	...
	function statLatestVideoMandatoryByCategoryCompany(idCompany) {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-video-mandatory-by-category-and-company/') ?>" + idCompany;
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
	...
	function statLatestVideoMandatoryByUploader() {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-video-mandatory-by-uploader') ?>";
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
	...
	function statHistoryVideoMandatoryYearly() {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-history-video-mandatory-yearly') ?>";
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
	...
	function statHistoryVideoMandatoryMonthly(year) {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-history-video-mandatory-monthly/') ?>" + year;
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
	...
	function statHistoryVideoMandatoryByCategoryYearly() {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-history-video-mandatory-by-category-yearly') ?>";
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
	...
	function statHistoryVideoMandatoryByCategoryMonthly(year) {
		...
		chart.dataSource.url = "<?= base_url(index_page() . '/stat-history-video-mandatory-by-category-monthly/') ?>" + year;
		chart.dataSource.parser = new am4core.JSONParser();
		chart.dataSource.parser.options.emptyAs = 0;
