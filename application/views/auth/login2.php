...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
            <form class="box validate-form" method="post" id="form-login">
				<img src="https://upload.wikimedia.org/wikipedia/commons/0/09/TransMedia.svg" alt="Girl in a jacket" width="400" height="60">
                    ...
                    <!-- <input type="submit" id="btn-login" class="login100-form-btn" onclick="login()" value="Login"> -->
                    <br/>
                    ...
                    <!-- <div class="col-md-12">
                        <ul class="social-network social-circle">
                            ...
                            <li><a href="#" class="icoGoogle" title="Instagram"><i class="fab fa-instagram"></i></a></li>
                        </ul>
                    </div> -->
                </form>
            </div>
