...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="h3 mb-4 text-gray-800">User Request</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <a href="#video_metadata" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
          <h6 class="m-0 font-weight-bold text-gray-800">User Request History</h6>
        </a>
        ...
        <div class="collapse show" id="video_metadata">
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="user_request" width="100%" cellspacing="0">
                <thead>
                  <tr>
					<th>No</th>
                    <th>Request Date</th>
    ...
    <div class="modal fade" id="modal_reject" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body form">
            <form action="#" id="formrejectrequest" class="form-horizontal" enctype="multipart/form-data">
              <input  type="hidden" value="" id="id" name="id" />
              <div class="form-body">
			  
                <div class="form-group">
                  <label class="control-label col-md-6">Reason of Rejection</label>
                  <div class="col-md-12 mb-12">
					<input type="text" class="form-control" placeholder="Enter Reason of Rejection" name="reasonreject" id="reasonreject">
                  </div>
                </div>
              </div>
            </form>
          <div class="modal-footer">
            <button type="button" id="btnSave" onclick="save_modal_rejected()" class="btn btn-success"><i class="glyphicon glyphicon-check"></i> Submit</button>
            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="glyphicon glyphicon-remove"></i> Cancel</button>
          </div>
        </div>
      </div>
