...
-- Dumping data for table content_provider.groups_auth: ~14 rows (approximately)
...
INSERT INTO `menu` (`id`, `created`, `modified`, `id_type`, `content`, `link`, `icon`, `is_parent`, `id_parent`, `level`, `have_function`, `active`, `short`) VALUES
	...
	(5, '2020-02-18 16:56:53', '2020-10-13 12:34:49', 1, 'Incoming Request', 'incoming_request', 'fas fa-fw fa-history', 0, 0, 0, 0, 1, 6),
	(6, '2020-02-18 16:59:50', '2020-10-13 11:58:11', 1, 'My Request', 'my_request', 'fas fa-fw fa-list', 0, 0, 0, 0, 1, 7),
...
-- Dumping data for table content_provider.request_transaction: ~0 rows (approximately)
/*!40000 ALTER TABLE `request_transaction` DISABLE KEYS */;
INSERT INTO `request_transaction` (`id`, `request_date`, `from`, `send_to`, `request_program`, `notes`, `status`, `receive_date`, `active`) VALUES
	(1, '2020-10-03 00:00:00', NULL, '5', 'Live News 20 September', 'Part 1', 'Waiting', '0000-00-00 00:00:00', 1),
	(2, '2020-10-23 00:00:00', NULL, '9', 'Prilly Interview', 'Part 3', 'Waiting', '0000-00-00 00:00:00', 1),
	(3, '2020-10-14 00:00:00', NULL, '4', 'Trans Studio Ad\'s', 'Part 1', 'Waiting', '0000-00-00 00:00:00', 1),
	(4, '0000-00-00 00:00:00', NULL, '2', 'Hitam Putih Spesial', 'Halloween Part 1,2,3', 'Waiting', '0000-00-00 00:00:00', 1),
	(5, '2020-10-14 00:00:00', NULL, '7', 'Final Copa Eropa', 'Sesi 1 Hotshot 3', 'Waiting', '0000-00-00 00:00:00', 1),
	(6, '2020-10-15 00:00:00', NULL, '3', 'One Stop FootBall', 'Sesi5', 'Waiting', '0000-00-00 00:00:00', 1),
	(7, '2020-10-14 00:00:00', NULL, '5', 'CNBC Spesial', '', 'Waiting', '0000-00-00 00:00:00', 1);
/*!40000 ALTER TABLE `request_transaction` ENABLE KEYS */;
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `token_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `image`, `nik`, `id_group`) VALUES
	...
	(9, '127.0.0.1', 'kemal.wibisono@cnn.id', '739c6beead44c6c4b99838fb98d00813793b80071a4e1182f660956c5b7d03d5f85d0f3f07845d7e2cc610a8fcf9f328f192b91aaf17f161de10618d48e6de8avoFcmpaktkh1vZMSUnZvdikUEwEhgIWaP+IAU7pRm+8=', NULL, 'kemal.wibisono@cnn.id', NULL, '72075400', NULL, NULL, '2018-08-29', '2020-10-13 06:07:41', 'WpnY4Ynk8gMds2vAzkFmREu4Zv39BQBS2jccmhhTcANEguhR6IIqjeN8y2RmomCGByWr7PAjwQL8wvwnJLpiFfTRVTKvXtoZMxQ9', 1, 'Fakhri', 'Ammarrizky', 'CNN Indonesia', '082308236576', 'img.png', 200271154, 1),
